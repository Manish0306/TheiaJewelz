          ...
          <div class="p-6 border-b border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200">
                ...
                <div id="totalSalesAmount" class="text-2xl font-bold text-blue-800">₹0</div>
              </div>
              <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
                <div class="text-sm text-green-600 font-medium">Total Profit</div>
                <div id="totalProfitAmount" class="text-2xl font-bold text-green-800">₹0</div>
              </div>
            </div>
          </div>
          ...
          <div class="p-6 border-b border-gray-200">
            ...
            <div class="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg p-4 border border-orange-200">
              <div class="flex items-center justify-between">
                ...
                <span id="totalPurchaseCost" class="text-2xl font-bold text-orange-800">₹0</span>
              </div>
            </div>
          </div>
